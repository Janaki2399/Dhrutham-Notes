...
export const LabelList = ({ isLabelListOpen }) => {
  ...
  return (
    <div
      className={
        isLabelListOpen
          ? " transform transition ease-in-out duration-150 mt-14 fixed w-3/5 md:w-1/5 left-0 overflow-y-auto h-screen  z-20 bg-white "
          : "mt-16 md:fixed md:block md:w-1/5 fixed left-0 overflow-y-auto h-screen hidden w-56 "
      }
      style={{ height: "98vh" }}
    >
      <div
